	...
	public class SqlPersistenceEngine : IPersistStreams
	{
		...
		private void PersistCommit(Commit attempt)
		{
			...
			this.ExecuteCommand(attempt.StreamId, cmd =>
			{
                ...
                //Console.WriteLine(this.serializer.Serialize(attempt.Events).ToString());
                //Console.WriteLine(System.Text.Encoding.ASCII.GetString(this.serializer.Serialize(attempt.Events)));

                //byte[] serializedEvents = this.serializer.Serialize(attempt.Events);
                //string stringSerializedEvents = System.Text.Encoding.ASCII.GetString(serializedEvents);
                ...
                //TODO remove test
                //cmd.AddParameter(this.dialect.StringValue, attempt.Events[0].ToString());
                Console.WriteLine(" Event = "  + attempt.Events[0].ToString());
                cmd.AddParameter(this.dialect.StringValue, attempt.Events[0].ToString());
